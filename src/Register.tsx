    ...
    return (
        <View style={styles.registerContainer} >
            <View style={styles.topContainerStyle} >
                ...
                <Text style={styles.fillFormTextStyle} >
                    { FILL_FORM_TEXT }
                </Text>
            </View>
            <View style={styles.middleContainerStyle} >
                <View style={styles.fullNameContainerStyle} >
                    ...
                    <TextInput style={styles.textInputStyle} placeholder={FULL_NAME_PLACEHOLDER_TEXT} />
                </View>
                <View style={styles.emailContainerStyle} >
                    <FontAwesome5 name="paper-plane" size={20} />
                    <TextInput style={styles.textInputStyle} placeholder={EMAIL_ADDRESS_PLACEHOLDER_TEXT} />
                </View>
                <View style={styles.phoneContainerStyle} >
                    <FontAwesome5 name="phone" size={20} />
                    <TextInput style={styles.textInputStyle} placeholder={PHONE_NUMBER_PLACEHOLDER_TEXT} />
                </View>
                <View style={styles.passwordContainerStyle} >
                    <FontAwesome5 name="lock" size={20} />
                    <TextInput style={styles.textInputStyle} placeholder={PASSWORD_PLACEHOLDER_TEXT} secureTextEntry={showPassword ? false: true} />
                    <Pressable style={{transform: [{rotateY: '180deg'}]}} onPress={togglePassword} >
                        <FontAwesome5 name={ !showPassword ? "eye-slash" : "eye"} size={20}  />
                    </Pressable>
                </View>
            </View>
            <View style={styles.bottomContainerStyle} >
                <Pressable style={styles.signUpContainerStyle} onPress={onSignUpPress} >
                    <Text style={styles.signUpTextStyle} >
                        { SIGN_UP_TEXT }
                    </Text>
                </Pressable>
                <View style={styles.signInContainer} >
                    <Text style={styles.havingAccountTextStyle} >
                        { HAVE_ACCOUNT_TEXT }
                    </Text>
                    <Text style={styles.signInTextStyle} onPress={onSignInPress} >
                        { SIGN_IN_TEXT }
                    </Text>
                </View>
            </View>
